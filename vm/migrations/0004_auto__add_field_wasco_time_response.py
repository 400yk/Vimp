...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wasco.time_response'
        db.add_column(u'Wasco', 'time_response',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wasco.time_response'
        db.delete_column(u'Wasco', 'time_response')
    ...
    models = {
        u'vm.wasco': {
            ...
            'time_response': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
